        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-12 col-xs-12 wow fadeInUp">
                ...
                <?php 
                        ...
                        $consultarNoticias = "SELECT nc.cod_categoria, nc.categoria, p.* FROM noticias as p, noticias_categorias as nc WHERE p.cod_categoria=nc.cod_categoria AND p.estado='1' ORDER BY fecha ASC $limite";
