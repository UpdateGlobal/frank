...
if($proceso=="Actualizar"){
  ...
  $orden            = $_POST['orden'];
  $estado           = $_POST['estado'];
  $actualizarCategoria  = "UPDATE galerias_categorias SET cod_categoria='$cod_categoria', categoria='$categoria', orden='$orden', estado='$estado' WHERE cod_categoria='$cod_categoria'";
